    ...
    <nav aria-label="Page navigation">
        <ul class="pagination justify-content-end" id="news-pagination">
            <li class="page-item page-disabled">
                <a class="page-link"><i class="fa-solid fa-angle-left" style="font-size: 20px;"></i></a>
            </li>
            ...
            <li class="page-item">
                <a class="page-link" href="#"><i class="fa-solid fa-angle-right" style="font-size: 20px;"></i></a>
            </li>
        </ul>
    </nav>
